                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto p-5 br-5">
                        <form action="{{ route('databarang.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <h2 class="nav-heading" style="font-family: 'General Sans', sans-serif;font-weight:500">Edit Barang</h2>
                            <hr>
                            <div class="row mt-5">
                                ...
                                <div class="col-10">
                                    <input type="text" id="namabarang" name="namabarang" value="{{ $data->nama }}"
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-10">
                                    <input type="text" id="jumlahbarang" name="jumlahbarang" value="{{ $data->jumlah_default }}"
                                    style="padding: 15px; width: 100%; border: 1px solid rgba(255, 255, 255, 0.636); background: #F0F2F5; line-height: normal; border-radius: 10px"
                                    placeholder="">
                                </div>
                            </div>
